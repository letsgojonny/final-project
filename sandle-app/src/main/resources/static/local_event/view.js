...
let no = localStorage.getItem("localNo");

function getLocal(no) {
  ...
  fetch("../locals/" + no)
    ...
    .then((result) => {
      ...
      document.querySelector("#f-nickname").value = local.nickname;
      document.querySelector("#f-createdDate").value = local.createdDate;
